...
class WpcCpuBoard {
  ...
  executeCycle(ticksToRun, tickSteps) {
    ...
    if (this.lastRegPC === this.cpu.regPC) {
      this.loopDetection++;
      if (this.loopDetection > 132) {
        console.log('this.loopDetection',this.loopDetection,this.cpu.regPC.toString(16));
        this.cpu.irq();
        //this.cpu.clearIrqMasking();
        //this.cpu.clearFirqMasking();
        this.loopDetection = 0;
